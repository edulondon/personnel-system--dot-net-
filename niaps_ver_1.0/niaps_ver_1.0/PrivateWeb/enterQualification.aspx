<%@ Page Title="" Language="C#" MasterPageFile="~/PrivateWeb/admin.Master" AutoEventWireup="true" CodeBehind="enterQualification.aspx.cs" Inherits="niaps_ver_1._0.PrivateWeb.enterQualification" %>
    ...
    <form id="createStaff" runat="server">
        <table id="pattern-style-a"><thead>
           <tr style="width:150px; height:30px; background-color:ActiveCaption">
                <td colspan="5"><h4>Educational Qualification</h4>
                    <asp:Label ID="msg" runat="server" Text=""></asp:Label></td></tr></thead><tbody>
            <tr>
                <td>Staff Id</td><td>
                    <asp:TextBox ID="sid" runat="server" ReadOnly="True"></asp:TextBox></td><td>Name</td><td>
                    <asp:DropDownList ID="sname" runat="server" Width="152px" AutoPostBack="True" DataSourceID="EntityDataSource1" DataTextField="lName" DataValueField="staffId" OnSelectedIndexChanged="sname_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <tr>
                <td>Basic Qualification</td><td>
                    <asp:TextBox ID="basicQ" runat="server"></asp:TextBox></td><td></td><td>&nbsp;</td><td>
                    &nbsp;</td>
            </tr>
             <tr>
                <td>Degree</td><td>
                <asp:DropDownList ID="degree" runat="server" Width="168px">
            ...
            <tr>
                ...
                <asp:DropDownList ID="qday" runat="server" Width="50px">
                ...
                <asp:DropDownList ID="qmonth" runat="server" Width="65px">
                    ...
                    <asp:DropDownList ID="qyear" runat="server" Width="50px">
            ...
            <tr>
                <td>Institution</td><td>
                    <asp:TextBox ID="inst" runat="server"></asp:TextBox></td><td colspan="2">eg. UNILAG, UI, CCNA or ICAN</td><td>
                &nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td><td>
