<%@ Page Title="" Language="C#" MasterPageFile="~/PrivateWeb/admin2.Master" AutoEventWireup="true" CodeBehind="changePsw2.aspx.cs" Inherits="niaps_ver_1._0.PrivateWeb.changePsw2" %>
...
<li><a href="regAsset.aspx">Home</a><span class="divider">/</span></li>
    <li><a href="changePsw2.aspx">change password</a><span class="divider"></span></li>
</ul>
         </div>--%>
    <form runat="server" id="changePsw">
        <table class="table"><thead><tr>
            <td class="auto-style1"><h5>Change Password</h5></td><td>
