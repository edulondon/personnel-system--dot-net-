<%@ Page Title="" Language="C#" MasterPageFile="~/PrivateWeb/admin.Master" AutoEventWireup="true" CodeBehind="inactiveStaffList.aspx.cs" Inherits="niaps_ver_1._0.PrivateWeb.inactiveStaffList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ListView ID="ListView1" runat="server" ItemType="niaps_ver_1._0.staffRecord" SelectMethod="GetStaff">
        ...
        <asp:Label ID="staffDetail" runat="server"></asp:Label>
              <tbody>   <tr><td style="width:15%"><%#: Item.staffId %></td><td style="width:15%"><%#: Item.lName %></td><td style="width:15%"><%#: Item.fName %></td><td style="width:15%"><%#: Item.gender %></td><td style="width:15%"><a href="staffDetails.aspx?staffId=<%#: Item.staffId %>">detail</a></td></tr>         
            </tbody>
        </ItemTemplate>
    </asp:ListView>
        </table>
